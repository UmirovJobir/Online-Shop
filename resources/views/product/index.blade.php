                                    ...
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <div>
                                                    <form class="form-inline" action="{{ route('products.index') }}" method="get">
                                                        <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" pattern="\d*" name="price">
                                                        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
                                                    </form>
                                                </div>
                                                <div>Цена</div>
                                            ...
                                            <th>
                                                <div>
                                                    <form class="form-inline" action="{{ route('products.index') }}" method="get">
                                                        <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" pattern="\d*" name="user">
                                                        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
                                                    </form>
                                                </div>
                                                <div>User</div>
